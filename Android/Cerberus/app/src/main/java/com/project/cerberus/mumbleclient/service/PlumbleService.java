...
import com.project.cerberus.jumble.JumbleService;
...
import com.project.cerberus.jumble.util.JumbleObserver;
import com.project.cerberus.mumbleclient.Settings;
import com.project.cerberus.mumbleclient.service.ipc.TalkBroadcastReceiver;
import com.project.cerberus.mumbleclient.util.HtmlUtils;
...
public class PlumbleService extends JumbleService implements
        ...
        com.project.cerberus.mumbleclient.service.PlumbleConnectionNotification.OnActionListener,
        com.project.cerberus.mumbleclient.service.PlumbleReconnectNotification.OnActionListener, com.project.cerberus.mumbleclient.service.IPlumbleService {
    ...
    private com.project.cerberus.mumbleclient.service.PlumbleConnectionNotification mNotification;
    private com.project.cerberus.mumbleclient.service.PlumbleMessageNotification mMessageNotification;
    private com.project.cerberus.mumbleclient.service.PlumbleReconnectNotification mReconnectNotification;
...
//            }
//
//            mNotification = com.project.cerberus.mumbleclient.service.PlumbleConnectionNotification.create(PlumbleService.this,
...
//        }
        ...
        public void onDisconnected(JumbleException e) {
            ...
            if (e != null && !mSuppressNotifications) {
                mReconnectNotification =
                        com.project.cerberus.mumbleclient.service.PlumbleReconnectNotification.show(PlumbleService.this, e.getMessage(),
                                isReconnecting(),
                                PlumbleService.this);
            }
        }
    ...
    public void onCreate() {
        ...
        mMessageNotification = new com.project.cerberus.mumbleclient.service.PlumbleMessageNotification(PlumbleService.this);
    }
    ...
    public static class PlumbleBinder extends Binder {
        ...
        public com.project.cerberus.mumbleclient.service.IPlumbleService getService() {
            return mService;
        }
    }
}