...
import com.project.cerberus.jumble.audio.AudioOutput;
import com.project.cerberus.jumble.audio.BluetoothScoReceiver;
import com.project.cerberus.jumble.audio.inputmode.ActivityInputMode;
import com.project.cerberus.jumble.audio.inputmode.ContinuousInputMode;
import com.project.cerberus.jumble.audio.inputmode.IInputMode;
import com.project.cerberus.jumble.audio.inputmode.ToggleInputMode;
import com.project.cerberus.jumble.audio.javacpp.CELT7;
import com.project.cerberus.jumble.exception.AudioException;
import com.project.cerberus.jumble.exception.NotConnectedException;
import com.project.cerberus.jumble.exception.NotSynchronizedException;
...
import com.project.cerberus.jumble.model.Message;
import com.project.cerberus.jumble.model.Server;
import com.project.cerberus.jumble.model.TalkState;
import com.project.cerberus.jumble.model.User;
import com.project.cerberus.jumble.model.WhisperTarget;
import com.project.cerberus.jumble.model.WhisperTargetList;
import com.project.cerberus.jumble.net.JumbleConnection;
...
import com.project.cerberus.jumble.net.JumbleTCPMessageType;
import com.project.cerberus.jumble.protobuf.Mumble;
import com.project.cerberus.jumble.protocol.AudioHandler;
import com.project.cerberus.jumble.protocol.ModelHandler;
import com.project.cerberus.jumble.util.JumbleCallbacks;
import com.project.cerberus.jumble.util.JumbleLogger;
import com.project.cerberus.jumble.util.VoiceTargetMode;
...
public class JumbleService extends Service implements IJumbleService, IJumbleSession, JumbleConnection.JumbleConnectionListener, JumbleLogger, BluetoothScoReceiver.Listener {
    ...
    protected void connect() {
        try {
            ...
            mConnection.connect(mServer.getHost(), mServer.getPort(),this.getApplicationContext());
...
//            auth.addCeltVersions(Constants.CELT_11_VERSION);
     ...
     * @see com.project.cerberus.jumble.JumbleService
     */
    ...
    public static class JumbleBinder extends Binder {
        ...
        public JumbleBinder(IJumbleService service) {
            mService = service;
        }
